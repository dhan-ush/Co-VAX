...
function AddStaff(props) {
  ...
  const supplierSubmit = (e) => {
    ...
    axios.post("http://localhost:3001/AddStaff", staff).then((response) => {
      ...
      } else if (response.data === "Staff Exists") {
              ...
              >
                <div className={st.detailsBox}>
                  <div className={st.rightL}>
                    <div>
                      <label className={st.label} htmlFor="aadhar_number">
                        Staff's Aadhar Number :{" "}
                      </label>
                      <br />
                      <input
                    ...
                    <div className={st.optt}>
                      <label className={st.label} htmlFor="role">
                        {" "}
                        Role :{" "}
                      </label>
                      <br />
                      <div className={st.radioRow111}>
                        ...
                        <div className={st.op}>
                          <input
                            ...
                            type="radio"
                            id="Asst. Medical Officer"
                            name="role"
                            value="Asst. Medical Officer"
                          />
                          <label
                            className={st.radiolabel1}
                            for="Asst. Medical Officer"
                          >
                        ...
                        <div className={st.op}>
                          <input
                            ...
                            value="Compounder"
                          />
                          <label className={st.radiolabel1} for="Compounder">
                            Compounder
                          </label>
                          <br></br>
                        </div>
