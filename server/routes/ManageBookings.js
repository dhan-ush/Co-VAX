      ...
      if (err) {
        ...
        if(dose_number==2){
          db.query(
            ...
            [aadhar_number,dose_number,aadhar_number,center_id,result[0].date,result[0].center_id,aadhar_number],
            async(err,result2)=>{
              if (err) {
                res.send({ err: err });
              }else{
          ...
          db.query(
            ...
            [aadhar_number,dose_number,aadhar_number,center_id,aadhar_number,result[0].date,center_id,vaccine_name,result[0].date,-1,"NA"],
            async(err,result2)=>{
              if (err) {
              //   db.query(
